# Claude-Skills-for-Epidemiology-Researchers
Two custom Claude AI Skills built for epidemiologists and public health researchers. Designed to cut through generic AI responses and deliver structured, methods-aware outputs for the tasks we actually do.

## How to Use
1. Open [Claude.ai](https://claude.ai)
2. Copy the contents of the skill's `SKILL.md` file
3. OR paste it as a **custom instruction** or at the start of a new conversation as a system-level prompt
...
Welcome any feedbacks and thoughts on how to improve:)
